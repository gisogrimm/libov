...
void ov_render_base_t::start_session() { session_active = true; }

void ov_render_base_t::end_session() { session_active = false; }

void ov_render_base_t::start_audiobackend() { audio_active = true; }
void ov_render_base_t::stop_audiobackend() { audio_active = false; }

const bool ov_render_base_t::is_session_active() const {
  return session_active;
}

const bool ov_render_base_t::is_audio_active() const { return audio_active; }
...
void ov_render_base_t::clear_stage() { stage.stage.clear(); }
