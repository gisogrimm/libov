...
namespace ds_types {
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(custom_stage_member_t, _id, stageMemberId, volume, muted, x, y, z, rX, rY, rZ)
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(soundcard_t, _id, userId, name, driver, numInputChannels, numOutputChannels, trackPreset, sampleRate, periodSize, numPeriods)
