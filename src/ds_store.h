...
namespace ds {
    ...
    public:
        ...
        boost::optional<const ds::json::stage_t> readStage(const std::string &stageId);
        ...
        boost::optional<const ds::json::custom_group_t> readCustomGroup(const std::string &id);
        ...
        boost::optional<const ds::json::stage_member_t> readStageMember(const std::string &id);
        ...
        boost::optional<const ds::json::custom_stage_member_t> readCustomStageMember(const std::string &id);
        ...
        boost::optional<const ds::json::soundcard_t> readSoundCard(const std::string &id);
        ...
        boost::optional<const ds::json::ov_track_t> readOvTrack(const std::string &id);
        ...
        boost::optional<const ds::json::remote_ov_track_t> readRemoteOvTrack(const std::string &id);
        ...
        boost::optional<const ds::json::custom_remote_ov_track_t> readCustomRemoteOvTrack(const std::string &id);
