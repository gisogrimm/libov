...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(device_t,
                                   _id,
                                   userId,
                                   online,
                                   mac,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(stage_t,
                                   _id,
                                   name,
                                   width,
                                   length,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(stage_member_t,
                                   _id,
                                   groupId,
                                   userId,
                                   online,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(custom_stage_member_t,
                                   _id,
                                   userId,
                                   stageMemberId,
                                   stageId,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(soundcard_t,
                                   _id,
                                   deviceId,
                                   name,
                                   isDefault,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(remote_ov_track_t,
                                   _id,
                                   ovTrackId,
                                   stageMemberId,
                                   channel,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(custom_remote_ov_track_t,
                                   _id,
                                   stageMemberId,
                                   remoteOvTrackId,
                                   directivity,
